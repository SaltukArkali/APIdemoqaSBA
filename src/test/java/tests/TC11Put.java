...
//          response.prettyPrint();
    ...
    public void TC1102(){
        ...
        jsonPath = response.jsonPath();
        System.out.println("Once : "+ jsonPath.getList("books.isbn"));
        Assert.assertTrue(jsonPath.getList("books.isbn").contains("9781593277574"));
        ...
        response.
                ...
                assertThat().
                statusCode(200);
        Assert.assertFalse(jsonPath.getList("books.isbn").contains("9781593277574"));
    ...
    public void TC1103(){
        ...
        jsonPath = response.jsonPath();
        System.out.println("TC03 mevcut Liste :"+ jsonPath.getList("books.isbn"));
    ...
    getUserBooks();
        ...
        Assert.assertEquals(jsonPath.getString("code"),"1200");
        Assert.assertEquals(jsonPath.getString("message"),"User not authorized!");
